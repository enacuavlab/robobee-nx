...
class MyWindow(Gtk.ApplicationWindow):
    def __init__(self, app):
        ...
        self.h_scale.set_size_request(30,100)
...
#        self.h_scale1 = Gtk.Scale(orientation=Gtk.Orientation.HORIZONTAL, adjustment=ad1)
#        self.h_scale1.set_digits(0)
#        self.h_scale1.set_hexpand(True)
#        self.h_scale1.set_valign(Gtk.Align.START)
